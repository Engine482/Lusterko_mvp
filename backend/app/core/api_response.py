...
DEFAULT_STATUS_FOR_CODE: Final[dict[ErrorCode, int]] = {
    ...
    "INVALID_DEMO_TOKEN": status.HTTP_400_BAD_REQUEST,
    "DEMO_TOKEN_EXPIRED": status.HTTP_400_BAD_REQUEST,
    "DEMO_EMAIL_TAKEN": status.HTTP_409_CONFLICT,
    "DEMO_REGISTRATION_DISABLED": status.HTTP_403_FORBIDDEN,
