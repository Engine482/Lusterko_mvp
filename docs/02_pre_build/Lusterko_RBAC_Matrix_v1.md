...
### 5.1 Shared routes
- auth/login: публічний (rate-limited)
- auth/invite/accept: публічний (rate-limited)
- auth/password/forgot: публічний (rate-limited, anti-enumeration)
- auth/password/reset: публічний (rate-limited)
- auth/me: усі ролі (вимагає сесії)
- auth/select-role: усі ролі (вимагає сесії)
- auth/refresh: усі ролі (вимагає сесії)
- auth/logout: усі ролі (вимагає сесії)
